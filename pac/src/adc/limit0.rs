...
pub type R = crate::R<Limit0Spec>;
#[doc = "Register `LIMIT0` writer"]
pub type W = crate::W<Limit0Spec>;
...
impl W {
    #[doc = "Bits 0:9 - Low Limit Threshold"]
    #[inline(always)]
    pub fn ch_lo_limit(&mut self) -> ChLoLimitW<Limit0Spec> {
        ChLoLimitW::new(self, 0)
    }
    #[doc = "Bits 12:21 - High Limit Threshold"]
    #[inline(always)]
    pub fn ch_hi_limit(&mut self) -> ChHiLimitW<Limit0Spec> {
        ChHiLimitW::new(self, 12)
    }
    #[doc = "Bits 24:28 - ADC Channel Select"]
    #[inline(always)]
    pub fn ch_sel(&mut self) -> ChSelW<Limit0Spec> {
        ChSelW::new(self, 24)
    }
    #[doc = "Bit 29 - Low Limit Monitoring Enable"]
    #[inline(always)]
    pub fn ch_lo_limit_en(&mut self) -> ChLoLimitEnW<Limit0Spec> {
        ChLoLimitEnW::new(self, 29)
    }
    #[doc = "Bit 30 - High Limit Monitoring Enable"]
    #[inline(always)]
    pub fn ch_hi_limit_en(&mut self) -> ChHiLimitEnW<Limit0Spec> {
        ChHiLimitEnW::new(self, 30)
    }
}
#[doc = "ADC Limit\n\nYou can [`read`](crate::Reg::read) this register and get [`limit0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`limit0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Limit0Spec;
impl crate::RegisterSpec for Limit0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`limit0::R`](R) reader structure"]
impl crate::Readable for Limit0Spec {}
#[doc = "`write(|w| ..)` method takes [`limit0::W`](W) writer structure"]
impl crate::Writable for Limit0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets LIMIT0 to value 0"]
impl crate::Resettable for Limit0Spec {
